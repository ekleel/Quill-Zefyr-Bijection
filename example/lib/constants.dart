...
const QUILL_TO_ZEFYR_COMPLEX_JSON = {
  "ops": [
    ...
    {
      "insert":
          "الأساسية لدعم منصات إضافية وأهمها macOS و Windows في خطوة توسع للمنصات المدعومة من قبل تطبيقات كلمة لتتمكن من الاستمتاع بكتابة قصصك من خلال الويب وكل من ��نظمة iOS - Android - macOS - Windows.\nوفي هذه النسخة بالتحديد قمنا بإضافة عدد من المميزات الجديدة  وإليكم أهمها:\n"
    },
    {
      "insert": {"divider": true}
    },
    ...
    {"insert": "كما قمنا  بحل عشرات المشاكل التي تم الإبلاغ عنها م�� قبل الأعضاء ولهم جزيل الش��ر 🌹.\n"},
    {
      "insert": {"divider": true}
    },
...
const QUILL_TO_ZEFYR_ISSUE_JSON = {
  "ops": [
    {"insert": "السلام عليكم..\n"},
    {
      "insert": {"tweet": "1282747519626350592"}
...
const QUILL_TO_ZEFYR_HAS_ISSUE = {
  "ops": [
    ...
    {
      "insert":
          "كن قوي.\nاتعلم ماهو مخيف هو ذلك الصوت الذي يهمس في اذنك استمر استمر واصل حتى تصل وصوت في قلبك يقول لك قف فوضع خطير ولكن شخصية ضعيفة دائماً تقف وشخصية القوية دائماً تستمر استمرو حتى يتمزق كل شي الا حلمك تابع طريق ولا تتوقف ياصديقي فحياة تعلمك معنى الصبر وقوة وتحقيق الرغبة التي كانت ولا زالت في مخيلتك النجاح ليس بمكان واحد في كل مكان انت تصنع فرق في هذا المكان وعالم فقط استمر من اخترع الساعة ‏كان شخص يعاني من مرض  ‏التوحد ولكن اصبح ملهم وصنع تغير في هذا العالم ولم يجيب لحد تذكر أن وجودك هنا من اجل نجاحك أنت .\n#بشاير_المحمدي"
    },
    {
      "insert": {"divider": true}
    },
